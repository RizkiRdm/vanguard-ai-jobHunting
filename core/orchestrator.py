...
class JobOrchestrator:
    ...
    async def _handle_application(
        ...
        async with self.semaphore:
            ...
            for step in range(max_steps):
                ...
                await self._dispatch_action(page, decision, cfg, profile)
    ...
    async def _dispatch_action(self, page, decision: Dict, cfg: Dict, profile: UserProfile):
        """Map AI actions to Playwright commands with dynamic resource resolution."""
